...
//		rootFlowPanel.add(splitPanel);	
		...
		horizontalPanel.add(getDay0IntRateFlowPanel());
...
//				new IntRate(2.5, Double.parseDouble(day0IntRateTwoHalf.getText())));
	...
	private FlowPanel getDay0IntRateFlowPanel() {
	...
	private void populateHJMInputs(HJMCalib hjmInputs) {
		//vol principal components		
...
//		day0IntRateTwoHalf.setText("" + intRates.get(5).rate);		
	...
	private HJMCalib getDefaultInputs() {
		HJMCalib inputs = new HJMCalib();
