...
public class HJMVolGenerator {
	...
	public HJMVols getHJMVols(HJMCalib calib) {
	...
	private double getVol2(double tenor, HJMCalib calib) {
	...
	private double getVol3(double tenor, HJMCalib calib) {
	...
	private double getM(double tau, HJMCalib calib) {
		if (0 == tau)
			return 0;
